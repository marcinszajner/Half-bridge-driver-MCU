...
void DC_HRTIM1_Init(void)
{
  ...
  if (HAL_HRTIM_TimeBaseConfig(&hhrtim1, HRTIM_TIMERINDEX_MASTER, &pTimeBaseCfg)
      != HAL_OK)
  {
    Error_Handler();
  }
...
// For 16 sample per cycle
  ...
  HAL_HRTIM_WaveformOutputConfig(&hhrtim1, HRTIM_TIMERINDEX_TIMER_D,
  ...
  HAL_HRTIM_WaveformCompareConfig(&hhrtim1, HRTIM_TIMERINDEX_TIMER_F,
      HRTIM_COMPAREUNIT_2, &compare_config);
  ...
  HAL_HRTIM_WaveformCompareConfig(&hhrtim1, HRTIM_TIMERINDEX_TIMER_F,
      HRTIM_COMPAREUNIT_4, &compare_config);
  ...
  HAL_HRTIM_SoftwareUpdate(&hhrtim1,
      HRTIM_TIMERUPDATE_MASTER + HRTIM_TIMERUPDATE_D + HRTIM_TIMERUPDATE_F);
  ...
  hhrtim1.Instance->sCommonRegs.CR2 = (HRTIM_TIMERRESET_MASTER
      | HRTIM_TIMERRESET_TIMER_F | HRTIM_TIMERRESET_TIMER_D
      | HRTIM_TIMERUPDATE_MASTER | HRTIM_TIMERUPDATE_F | HRTIM_TIMERUPDATE_D);
  hhrtim1.Instance->sMasterRegs.MCR |= (HRTIM_TIMERID_MASTER
      | HRTIM_TIMERID_TIMER_F | HRTIM_TIMERID_TIMER_D);
